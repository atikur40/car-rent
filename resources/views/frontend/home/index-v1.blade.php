                  ...
                  <div class="row align-items-center gx-xl-3">
                    <div class="col-lg-11">
                      <div class="row">
                        ...
                        <div class="col-md col-sm-6">
                          <div class="form-group location border-end">
                    ...
                    @php
                      ...
                      $cars = App\Models\Car::join('car_contents', 'car_contents.car_id', 'cars.id')
                          ...
                          ->where([
                              ...
                              ['memberships.start_date', '<=', \Carbon\Carbon::now()->format('Y-m-d')],
                              ['memberships.expire_date', '>=', \Carbon\Carbon::now()->format('Y-m-d')],
                          ])
                          ->where([['vendors.status', 1], ['cars.is_featured', 1], ['cars.status', 1]])
                          ->where([
                              ['car_contents.language_id', $language->id],
                              ['car_contents.category_id', $car_category_id],
                          ])
                          ->select(
                              'cars.*',
                              'car_contents.slug',
