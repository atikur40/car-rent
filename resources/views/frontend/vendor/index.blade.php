    ...
    <div class="container">
      <div class="product-sort-area pb-20" data-aos="fade-up">
        <div class="row align-items-center">
          <div class="col-lg-12">
            <form action="{{ route('frontend.vendors') }}" method="GET"id="vendorSearchForm">
              <div class="row align-items-end">
                @if ($countries->count() > 0)
                  <div class="col-xl-2 col-lg-4 col-sm-6">
                    <div class="form-group mb-20">
                      <label class="mb-1" for="all">All</label>
                      <select name="country" id="all" class="form-control select2"
                        onchange="document.getElementById('vendorSearchForm').submit()">
                  ...
                  <div class="col-xl-2 col-lg-4 col-sm-6">
                    <div class="form-group mb-20">
                      ...
                      <select name="city" id="city"
                        class="form-control select2"onchange="document.getElementById('vendorSearchForm').submit()">
                        <option value="">{{ __('All') }}</option>
                ...
                <div class="col-xl-2 col-lg-4 col-sm-6">
                  ...
                  <label class="mb-1" for="vendore-name">Vendore Name</label>
                  <div class="form-group icon-start mb-20">
                    <span class="icon color-primary">
                      <i class="fas fa-user"></i>
                    </span>
                    <input type="text" name="name" id="vendore-name" value="{{ request()->input('name') }}"
                ...
                <div class="col-xl-2 col-lg-4 col-sm-6">
                  ...
                  <div class="form-group icon-start mb-20">
                    ...
                    <input type="text" name="location" id="location" class="form-control radius-0 border-primary"
            ...
            <div class="card mb-25 shadow-md radius-0">
              <div class="card-info-area bg-primary-light p-20">
                ...
                <div class="card-info">
                  ...
                  <div>
                    @php
                      $total_cars = App\Models\Car::where('vendor_id', $vendor->vendorId)->get()->count();
                    @endphp
