...
@section('content')
            ...
            <div class="col-sm-6 col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              <div class="text-right">
                ...
                <button class="btn btn-danger btn-sm ml-2 d-none bulk-delete"
                  data-href="{{ route('admin.car_specification.location.bulk_delete_state') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.car_specification.location.delete_state', ['id' => $state->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- edit modal --}}
  @include('backend.location.state.edit')
@endsection
@section('script')
