            ...
            <div class="row">
              <div class="col-lg-10 mx-auto">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="">{{ __('Home Page Logo') . '*' }}</label>
                      <br>
                      <div class="thumb-preview">
                        @if (!empty($data->home_page_logo))
                          <img src="{{ asset('assets/img/' . $data->home_page_logo) }}" alt="home_page_logo"
                            class="uploaded-img3">
                        @else
                      ...
                      <div class="mt-3">
                        <div role="button" class="btn btn-primary btn-sm upload-btn">
                          {{ __('Choose Image') }}
                          <input type="file" class="img-input3" name="home_page_logo">
                        </div>
                      </div>
                      @if ($errors->has('home_page_logo'))
                        <p class="mt-2 mb-0 text-danger">{{ $errors->first('home_page_logo') }}</p>
                      @endif
                    </div>
                  </div>
                </div>
