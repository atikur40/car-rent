      ...
      <ul class="nav nav-primary">
        ...
        @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Car Specifications', $rolePermissions)))
          <li
            ...
            @elseif (request()->routeIs('admin.car_specification.location.countries')) active 
            @elseif (request()->routeIs('admin.car_specification.location.states')) active 
            @elseif (request()->routeIs('admin.car_specification.location.city')) active 
            ...
            <div id="carSpecification"
              ...
              @elseif (request()->routeIs('admin.car_specification.location.countries')) show 
              @elseif (request()->routeIs('admin.car_specification.location.states')) show 
              @elseif (request()->routeIs('admin.car_specification.location.city')) show 
              ...
              <ul class="nav nav-collapse">
                ...
                <li class="submenu">
                  <a data-toggle="collapse"
                    href="#set-location"aria-expanded="{{ request()->routeIs('admin.car_specification.location.countries') || request()->routeIs('admin.car_specification.location.city') || request()->routeIs('admin.car_specification.location.states') ? 'true' : 'false' }}">
                  ...
                  <div id="set-location"
                    class="collapse 
                    @if (request()->routeIs('admin.car_specification.location.countries')) show 
                    @elseif (request()->routeIs('admin.car_specification.location.city')) show
                    @elseif (request()->routeIs('admin.car_specification.location.states')) show @endif">
                    <ul class="nav nav-collapse subnav">
                      <li
                        class="{{ request()->routeIs('admin.car_specification.location.countries') ? 'active' : '' }}">
                        <a
                          href="{{ route('admin.car_specification.location.countries', ['language' => $defaultLang->code]) }}">
                          <span class="sub-item">{{ __('Countries') }}</span>
                        </a>
                      </li>

                      <li class="{{ request()->routeIs('admin.car_specification.location.states') ? 'active' : '' }}">
                        <a
                          href="{{ route('admin.car_specification.location.states', ['language' => $defaultLang->code]) }}">
                          <span class="sub-item">{{ __('States') }}</span>
                        </a>
                      </li>

                      <li class="{{ request()->routeIs('admin.car_specification.location.city') ? 'active' : '' }}">
                        <a
                          href="{{ route('admin.car_specification.location.city', ['language' => $defaultLang->code]) }}">
          ...
          <li
            ...
            <div id="carManagement"
              ...
              <ul class="nav nav-collapse">
                ...
                <li class="{{ request()->routeIs('admin.listing_management.settings') ? 'active' : '' }}">
                  <a href="{{ route('admin.listing_management.settings', ['language' => $defaultLang->code]) }}">
                    <span class="sub-item">Views</span>
                  </a>
                </li>
