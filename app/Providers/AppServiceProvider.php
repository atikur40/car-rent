...
class AppServiceProvider extends ServiceProvider
{
  ...
  public function boot()
  {
    ...
    if (!app()->runningInConsole()) {
      # code...
      $data = DB::table('basic_settings')->select('favicon', 'website_title', 'logo', 'base_currency_text', 'base_currency_text_position', 'google_map_api_key_status', 'google_map_api_key', 'home_page_logo')->first();
      ...
      View::composer('backend.*', function ($view) {
        ...
        $websiteSettings = DB::table('basic_settings')->select('admin_theme_version', 'base_currency_symbol', 'base_currency_symbol_position', 'base_currency_symbol_position', 'base_currency_text_position', 'base_currency_text', 'base_currency_rate', 'theme_version', 'google_map_api_key_status', 'google_map_api_key')->first();
      ...
      View::composer('vendors.*', function ($view) {
        ...
        $websiteSettings = DB::table('basic_settings')->select('admin_theme_version', 'base_currency_symbol', 'base_currency_symbol_position', 'base_currency_text', 'base_currency_text_position', 'base_currency_rate', 'theme_version', 'google_map_api_key_status', 'google_map_api_key')->first();
