...
class CarController extends Controller
{
    ...
    {
        $info = DB::table('basic_settings')->select('car_view')->first();
        return view('backend.car.view', ['info' => $info]);
    }
    ...
    public function store(CarStoreRequest $request)
    {
        ...
        DB::transaction(function () use ($request) {
            ...
            foreach ($languages as $language) {
                ...
                $carContent->country_id = $request[$language->code . '_country_id'];
                $carContent->state_id = $request[$language->code . '_state_id'];
                $carContent->city_id = $request[$language->code . '_city_id'];
    ...
    public function edit($id)
    {
        ...
        $information['carAddress'] = CarContent::where([
