...
class BasicController extends Controller
{
  ...
  public function update_general_setting(Request $request)
  {
    ...
    if (!$request->filled('home_page_logo') && is_null($data->home_page_logo)) {
      $rules['home_page_logo'] = 'required';
    }
    if ($request->hasFile('home_page_logo')) {
      $rules['home_page_logo'] = new ImageMimeTypeRule();
    }
    ...
    if ($request->hasFile('home_page_logo')) {
      $homepagelogoName = UploadFile::update(public_path('assets/img/'), $request->file('home_page_logo'), $data->home_page_logo);
    } else {
      $homepagelogoName = $data->home_page_logo;
    }
    ...
    DB::table('basic_settings')->updateOrInsert(
      ...
      [
        ...
        'logo' => $logoName,
        'home_page_logo' => $homepagelogoName,
        'favicon' => $iconName,
