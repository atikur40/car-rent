...
Route::prefix('/admin')->middleware('auth:admin')->group(function () {
  ...
  Route::prefix('car-specification')->group(function () {
    ...
    Route::prefix('location')->group(function () {
      ...
      //  Country route
      Route::get('/countries', 'BackEnd\Location\CountryController@index')->name('admin.car_specification.location.countries');

      Route::post('/store-country', 'BackEnd\Location\CountryController@store')->name('admin.car_specification.location.store_country');

      Route::post('/update-country', 'BackEnd\Location\CountryController@update')->name('admin.car_specification.location.update_country');

      Route::post('/delete-country/{id}', 'BackEnd\Location\CountryController@destroy')->name('admin.car_specification.location.delete_country');

      Route::post('/bulk-delete-country', 'BackEnd\Location\CountryController@bulkDestroy')->name('admin.car_specification.location.bulk_delete_country');


      //  states route
      Route::get('/states', 'BackEnd\Location\StateController@index')->name('admin.car_specification.location.states');

      Route::get('/get-country/{language_id}', 'BackEnd\Location\StateController@getCountry')->name('admin.car_specification.location.get-countries');

      Route::post('/store-state', 'BackEnd\Location\StateController@store')->name('admin.car_specification.location.store_state');

      Route::post('/update-state', 'BackEnd\Location\StateController@update')->name('admin.car_specification.location.update_state');

      Route::post('/delete-state/{id}', 'BackEnd\Location\StateController@destroy')->name('admin.car_specification.location.delete_state');

      Route::post('/bulk-delete-state', 'BackEnd\Location\StateController@bulkDestroy')->name('admin.car_specification.location.bulk_delete_state');

      //  City route

      Route::get('/city', 'BackEnd\Location\CityController@index')->name('admin.car_specification.location.city');
      Route::get('/get-state/{country}', 'BackEnd\Location\CityController@getState')->name('admin.car_specification.location.get-state');
      Route::post('/store-city', 'BackEnd\Location\CityController@store')->name('admin.car_specification.location.store_city');
      Route::post('/update-city', 'BackEnd\Location\CityController@update')->name('admin.car_specification.location.update_city');
      Route::post('/delete-city/{id}', 'BackEnd\Location\CityController@destroy')->name('admin.car_specification.location.delete_city');
      Route::post('/bulk-delete-city', 'BackEnd\Location\CityController@bulkDestroy')->name('admin.car_specification.location.bulk_delete_city');
    });
  });
  ...
  Route::prefix('car-management')->group(function () {
    ...
    Route::get('/views', 'BackEnd\Car\CarController@settings')->name('admin.listing_management.settings');
    Route::post('/update-settings', 'BackEnd\Car\CarController@updateSettings')->name('admin.listing_management.update_settings');
    ...
    Route::post('/get-state', 'BackEnd\Car\CarController@getState')->name('admin.car_management.get-state')->withoutMiddleware('Demo');
    Route::post('/get-city', 'BackEnd\Car\CarController@getCity')->name('admin.car_management.get-city')->withoutMiddleware('Demo');
    ...
    Route::get('edit-car/{id}', 'BackEnd\Car\CarController@edit')->name('admin.cars_management.edit_car');
  ...
  Route::prefix('/basic-settings')->middleware('permission:Basic Settings')->group(function () {
    ...
    Route::get('/general-settings', 'BackEnd\BasicSettings\BasicController@generalSettings')->name('admin.basic_settings.general_settings');
    ...
    Route::post(
      ...
      'BackEnd\BasicSettings\BasicController@updateGoogleMapApi'
