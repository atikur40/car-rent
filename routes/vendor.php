...
Route::prefix('vendor')->middleware('auth:vendor', 'Deactive')->group(function () {
  ...
  Route::prefix('car-management')->group(function () {
    ...
    Route::post('/get-state', 'Vendor\CarController@getState')->name('vendor.car_management.get-state')->withoutMiddleware('Demo');
    Route::post('/get-city', 'Vendor\CarController@getCity')->name('vendor.car_management.get-city')->withoutMiddleware('Demo');
